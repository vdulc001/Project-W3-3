...
public enum TokenKinds {
	...
	VOLATILE, WCHAR_T, WHILE, XOR, XOR_EQ, NULL_LITERAL, OR_EQ,
	LPAREN, RPAREN, LBRACE, RBRACE, LBRACK, RBRACK, SEMICOLON, COMMA, DOT,
	EQ, GT, LT, NOT_OP, COMP, QUESTION, EQEQ, LTEQ, GTEQ, NOTEQ, ANDAND, OROR,
	...
	STRING_LITERAL, INTEGER_LITERAL, IDENTIFIER, EOF, CHARACTER_LITERAL, 
	NULLPTR, OPERATOR, REFLEXPR, CAST};
